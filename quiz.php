...
<body>
	...
	<div class="home-box custom-box ">
		<h3>Instruction:</h3>
		<p>Total number of questions: <span class="total-questions">15</span></p>
	...
	<div class="result-box custom-box hide">
		...
		<!-- <a href="fulldemo.php"></a><button type ="button" class="btn">Logout</button></a> -->
		<!-- <button type="button" class="btn" onclick="location.href='fulldemo.php';">Logout</button> -->
	</div>
